...
export const Header = () => (
  <div>
    <EuiTitle size="s">
      <h3>
        <FormattedMessage id="kbn.management.indexPattern.edit.source.header" defaultMessage="Source filters"/>
      </h3>
    </EuiTitle>
    <EuiText>
      <p>
        <FormattedMessage
          id="kbn.management.indexPattern.edit.source.label"
...
at this lower level.`}
      ...
      <p>
        <FormattedMessage
          id="kbn.management.indexPattern.edit.source.note.label"
