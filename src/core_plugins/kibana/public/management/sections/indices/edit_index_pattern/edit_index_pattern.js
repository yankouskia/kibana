  ...
  .controller('managementIndicesEdit', function (
    ...
    $scope.refreshFields = function () {
      const confirmModalOptions = {
        confirmButtonText: i18n('kbn.management.indexPattern.edit.refresh.label', { defaultMessage: 'Refresh' }),
        onConfirm: async () => {
          await $scope.indexPattern.init(true);
          $scope.fields = $scope.indexPattern.getNonScriptedFields();
        },
        title: i18n('kbn.management.indexPattern.edit.refresh.question', { defaultMessage: 'Refresh field list?' })
      };
      confirmModal(
        i18n(
          'kbn.management.indexPattern.edit.refresh.describe',
    ...
    $scope.setIndexPatternsTimeField = function (field) {
      if (field.type !== 'date') {
        notify.error(i18n('kbn.management.indexPattern.edit.error.wrongType',
