...
export function IndicesEditSectionsProvider(i18n) {
  ...
  return function (indexPattern) {
    ...
    return [
      {
        title: i18n('kbn.management.indexPattern.edit.tabs.fields', { defaultMessage: 'Fields' }),
        index: 'indexedFields',
        count: fieldCount.indexed
      },
      {
        title: i18n('kbn.management.indexPattern.edit.tabs.scripted', { defaultMessage: 'Scripted fields' }),
        index: 'scriptedFields',
        count: fieldCount.scripted
      },
      {
        title: i18n('kbn.management.indexPattern.edit.tabs.source', { defaultMessage: 'Source filters' }),
        index: 'sourceFilters',
